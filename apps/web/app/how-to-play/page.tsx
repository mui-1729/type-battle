  ...
  return (
    <main className="appShell howToPlayPage">
      ...
      <section className="howToPlayGrid" aria-label="ゲームの遊び方">
        <SurfaceCard className="howToPlayCard">
          <div className="howToPlayCardHeader">
            <div className="howToPlayIcon" aria-hidden="true"><Swords size={30} /></div>
            <SectionHeading eyebrow="STEP 1" title="モードを選ぶ" />
          </div>
          <p>対戦するならルーム作成・参加・COM戦、ひとりで遊ぶなら練習・デイリーを選びます。</p>
        </SurfaceCard>
        <SurfaceCard className="howToPlayCard">
          <div className="howToPlayCardHeader">
            <div className="howToPlayIcon" aria-hidden="true"><Keyboard size={30} /></div>
            <SectionHeading eyebrow="STEP 2" title="表示された文字を入力" />
          </div>
          <p>日本語の課題文と、その下のローマ字を確認しながら入力します。</p>
        </SurfaceCard>
        <SurfaceCard className="howToPlayCard">
          <div className="howToPlayCardHeader">
            <div className="howToPlayIcon" aria-hidden="true"><BookOpen size={30} /></div>
            <SectionHeading eyebrow="STEP 3" title="結果を確認して再挑戦" />
          </div>
